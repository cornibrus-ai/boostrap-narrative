        ...
        <div className="content-wrapper max-w-3xl mx-auto">
          <div className="space-y-12">
            <div className="bg-secondary/30 rounded-xl p-8 border border-border/20">
              <h2 className="font-morganite text-2xl mb-3">On Starting</h2>
            ...
            <div className="bg-secondary/30 rounded-xl p-8 border border-border/20">
              <h2 className="font-morganite text-2xl mb-3">On Working with Others</h2>
              <p className="text-lg font-mono mb-4">
            ...
            <div className="bg-secondary/30 rounded-xl p-8 border border-border/20">
              <h2 className="font-morganite text-2xl mb-3">On Perseverance</h2>
              <p className="text-lg font-mono mb-4">
            ...
            <div className="bg-secondary/30 rounded-xl p-8 border border-border/20">
              <h2 className="font-morganite text-2xl mb-3">On Decision Making</h2>
              <p className="text-lg font-mono mb-4">
            ...
            <div className="bg-secondary/30 rounded-xl p-8 border border-border/20">
              <h2 className="font-morganite text-2xl mb-3">On Growth</h2>
              <p className="text-lg font-mono mb-4">
